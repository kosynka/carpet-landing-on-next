            ...
            <Container>
                <Row>
                    ...
                    <Col md={4}>
                        ...
                        <p className="text-muted">Нур-Султан, ул.Пушкина, д.1</p>
                        <p className="text-muted">Почта: email@email.com</p>
                        <p className="text-muted">Телефон: 8 700 700 8090</p>
                    ...
                    <Col md={4}>
                        <Row>
                        <Col md={4}>
                            <h4 className="text-dark mb-3">Активные ссылки</h4>
